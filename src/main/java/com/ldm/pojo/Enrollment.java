...
@NamedQueries({
    ...
    @NamedQuery(name = "Enrollment.findByAcademicYear", query = "SELECT e FROM Enrollment e WHERE e.academicYear = :academicYear"),
...
public class Enrollment implements Serializable {
    ...
    public Enrollment(Integer id, String academicYear) {
        this.id = id;
